...
from constants import data_root_path, key_points_max_size, key_points_desired_size, kp_train_path, kp_test_path, kp_manual_json_path, kp_json_path, constrast, kp_train_row, kp_train_col
import json
import numpy as np
